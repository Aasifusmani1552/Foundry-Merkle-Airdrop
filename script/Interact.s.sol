...
contract ClaimAirdrop is Script {
    ...
    // we deployed the merkle airdrop contract to use getMessageHash function and created the hash and then used cast wallet sign to get the signature, that's awesome!!!
